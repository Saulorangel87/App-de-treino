...
- A produção está no commit `9d8c624`; o checkout local está no commit `051d285` e contém a fatia `0.10.0` de registro explícito de treinos não realizados, validada localmente e ainda não publicada. O catálogo inicial, o piloto de estrada e o piloto de intervalos aeróbicos XCO estão publicados, sujeitos aos critérios de elegibilidade documentados.
