...
type Summary = { completed_sessions: number; cancelled_sessions: number; total_minutes: number; average_rpe: number; average_fatigue: number; completion_rate: number; total_distance_km: number; total_elevation_m: number; average_power_watts: number; average_heart_rate: number; weeks: Week[]; recovery: RecoveryPoint[] };
