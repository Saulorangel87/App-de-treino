...
type CyclingContext = { weekly_hours: number; longest_ride_minutes: number; weekly_rides: number; recent_weekly_distance_km: number; bike_type: string; terrain: string; uses_heart_rate: boolean; uses_power: boolean; ftp?: number; event_goal: boolean; event_distance_km?: number; event_date?: string };
...
const initialCyclingContext: CyclingContext = { weekly_hours: 0, longest_ride_minutes: 0, weekly_rides: 0, recent_weekly_distance_km: 0, bike_type: '', terrain: '', uses_heart_rate: false, uses_power: false, event_goal: false };
