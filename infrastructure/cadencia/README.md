...
No checkout atual, as migrações `000015`, `000016`, `000017`, `000018`, `000019`, `000020` e `000021` registram as fontes científicas do catálogo e os contextos de conclusão e feedback pós-treino. A produção foi atualizada até `000021` no deploy do commit `f0fec8b`. O catálogo inicial, os pilotos de estrada/XCO, o taper pré-prova, o piloto VO₂max de estrada, o piloto de intervalos curtos autorregulados, os contextos de conclusão/feedback pós-treino e as auditorias observacionais de periodização, seleção e coerência integrada dos estímulos foram publicados após revisão, backup verificável, execução ordenada pelo perfil `maintenance`, validação e autorização explícita. A versão comunicada ao usuário é `0.20.0`, registrada na release [v0.20.0](https://github.com/Saulorangel87/App-de-treino/releases/tag/v0.20.0).
