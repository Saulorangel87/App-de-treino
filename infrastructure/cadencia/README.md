...
No checkout atual, as migrações `000015`, `000016`, `000017`, `000018`, `000019`, `000020` e `000021` registram as fontes científicas do catálogo e os contextos de conclusão e feedback pós-treino. A produção foi atualizada até `000019` no deploy do commit `6fdbe45`; a `000020` e a `000021` permanecem locais. O catálogo inicial, os pilotos de estrada/XCO, o taper pré-prova, o piloto VO₂max de estrada e o piloto de intervalos curtos autorregulados foram publicados após revisão, backup verificável, execução ordenada pelo perfil `maintenance`, validação e autorização explícita. A versão comunicada ao usuário é `0.16.0`, registrada na release [v0.16.0](https://github.com/Saulorangel87/App-de-treino/releases/tag/v0.16.0).
