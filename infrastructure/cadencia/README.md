...
No checkout atual, as migrações `000015`, `000016`, `000017`, `000018`, `000019`, `000020` e `000021` registram as fontes científicas do catálogo e os contextos de conclusão e feedback pós-treino. A produção foi atualizada até `000021` no deploy do commit `84b653b`. O catálogo inicial, os pilotos de estrada/XCO, o taper pré-prova, o piloto VO₂max de estrada, o piloto de intervalos curtos autorregulados e os contextos de conclusão/feedback pós-treino foram publicados após revisão, backup verificável, execução ordenada pelo perfil `maintenance`, validação e autorização explícita. A versão comunicada ao usuário é `0.20.0`; a release correspondente ainda será registrada no GitHub.
