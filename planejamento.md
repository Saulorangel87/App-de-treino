...
Os quatro testes do novo avaliador passaram junto dos testes anteriores do shadow. Não houve migração, mudança visual, infraestrutura ou alteração das notas de versão. O próximo passo é decidir como observar essa avaliação dentro da transação de feedback e só depois discutir uma integração prescritiva, preservando o trigger existente até haver comparação e autorização explícita.
