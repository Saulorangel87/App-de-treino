...
- `controlled_threshold`: três blocos de 8 minutos com 4 minutos leves, piloto de limiar controlado liberado somente para perfil avançado elegível com preferência explícita; usa RPE e não define potência universal.
